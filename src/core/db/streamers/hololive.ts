export const hololive = [
  {
    name: 'AZKi', ytId: 'UC0TXe_LYZ4scaW2XMyi5_kw',
    chName: "AZKi Channel",
    picture: 'https://yt3.ggpht.com/ytc/AAUvwnh85tQLdg3chip7aFBjFZyORHi40WPjcFRWaQq8Wg=s800-c-k-c0x00ffffff-no-rj',
    groups: ['0th Generation'], twitter: 'AZKi_VDiVA',
    aliases: ['azki']
  },
  {
    name: 'Akai Haato', ytId: 'UC1CfXB_kRs3C-zaeTG3oGyg',
    chName: "HAACHAMA Ch 赤井はあと",
    picture: 'https://yt3.ggpht.com/ytc/AAUvwniwFyaWXOPJEGqA3afhSvRsiPDb0sYt8TlCMMWIig=s800-c-k-c0x00ffffff-no-rj',
  ...
  },
  {
    ...
    groups: ['3rd Generation'], twitter: 'usadapekora',
    aliases: ['peko', 'ペコ', 'ぺこ']
  },
  {
    name: 'Minato Aqua', ytId: 'UC1opHUrw8rvnsadT-iGp7Cg',
    chName: "Aqua Ch. 湊あくあ",
    picture: 'https://yt3.ggpht.com/ytc/AAUvwngPGs1t6iJAT6hLWj7cBQcvJg2y_L9mzpy3lpxgqw=s800-c-k-c0x00ffffff-no-rj',
    groups: ['2nd Generation'], twitter: 'minatoaqua',
    aliases: ['aqua', 'baqua', 'akutan', 'あくあ', 'あくたん']
  },
  {
    name: 'Yuzuki Choco', ytId: 'UC1suqwovbL1kzsoaZgFZLKg',
    chName: "Choco Ch. 癒月ちょこ",
    picture: 'https://yt3.ggpht.com/ytc/AAUvwnjONtr2IgqiXteDRhXt_yOiWlgPLicWOESGvKzZPQ=s800-c-k-c0x00ffffff-no-rj',
    groups: ['2nd Generation'], twitter: 'yuzukichococh',
    aliases: ['choco', 'chocosen', 'ちょこ']
  },
  {
    name: 'Tokoyami Towa', ytId: 'UC1uv2Oq6kNxgATlCiez59hw',
    chName: "Towa Ch. 常闇トワ",
    picture: 'https://yt3.ggpht.com/ytc/AAUvwnjPaiimZva5GECAyNDn0qraqPm62LlH-0oN21I5=s800-c-k-c0x00ffffff-no-rj',
    groups: ['4th Generation'], twitter: 'tokoyamitowa',
    aliases: ['towa', 'トワ']
  },
  {
    name: 'Hoshimachi Suisei', ytId: 'UC5CwaMl1eIgY8h02uZw7u8A',
    chName: "Suisei Channel",
    picture: 'https://yt3.ggpht.com/ytc/AAUvwnjdAl5rn3IjWzl55_0-skvKced7znPZRuPC5xLB=s800-c-k-c0x00ffffff-no-rj',
    groups: ['0th Generation'], twitter: 'suisei_hosimati',
    aliases: ['suisei', 'suichan', 'sui-chan', 'すいせい', 'すいちゃん']
  },
  {
    name: 'Hanasaki Miyabi', ytId: 'UC6t3-_N8A6ME1JShZHHqOMw',
    chName: "Miyabi Ch. 花咲みやび",
    picture: 'https://yt3.ggpht.com/ytc/AAUvwnj2P4FOShzQPX2-1rLfO_3Vbo7IyKQdK1PiF65w=s800-c-k-c0x00ffffff-no-rj',
    groups: ['Holostars 1st Gen'], twitter: 'miyabihanasaki',
    aliases: ['miyabi', 'みやび']
  },
  {
    name: 'Anya Melfissa', ytId: 'UC727SQYUvx5pDDGQpTICNWg',
    chName: "Anya Melfissa Ch. hololive-ID",
    picture: 'https://yt3.ggpht.com/ytc/AAUvwnie9uw8oBbjgTKmoLPSo9b_K0AbNPRbD2rjCApl=s800-c-k-c0x00ffffff-no-rj',
    groups: ['Indonesia 2nd Gen'], twitter: 'anyamelfissa',
    aliases: ['anya', 'アーニャ']
  },
  {
  ...
  },
  {
    ...
    chName: "Rikka ch.律可",
    picture: 'https://yt3.ggpht.com/ytc/AAUvwnghUH22DLP22EHC3PZP7xXzJFd7qS_scK95WhaQ=s800-c-k-c0x00ffffff-no-rj',
    groups: ['Holostars 1st Gen'], twitter: 'rikkaroid',
    aliases: ['rikka', 'rikka', 'りっか', '律可']
  },
  {
    name: 'Himemori Luna', ytId: 'UCa9Y57gfeY0Zro_noHRVrnw',
    chName: "Luna Ch. 姫森ルーナ",
    picture: 'https://yt3.ggpht.com/eUvyn2QlPppt7z5wew0upiGt2-o7c7rLKBlWynTrSdacjvtZYxZ7Sp6MuYumQJ-zSwzj6a6BDA=s800-c-k-c0x00ffffff-no-rj',
    groups: ['4th Generation'], twitter: 'himemoriluna',
    aliases: ['ルーナ', 'luna']
  },
  {
  ...
  },
  {
    ...
    picture: 'https://yt3.ggpht.com/ytc/AAUvwnh4NDjjjUAfPj8Aa4kjyQb4C85KzMWobSCaso-8=s800-c-k-c0x00ffffff-no-rj',
    groups: ['Indonesia 1st Gen'], twitter: 'airaniiofifteen',
    aliases: ['iofi', 'イオフィ']
  },
  {
    name: 'Momosuzu Nene', ytId: 'UCAWSyEs_Io8MtpY3m-zqILA',
    chName: "Nene Ch.桃鈴ねね",
  ...
  },
  {
    ...
    picture: 'https://yt3.ggpht.com/ytc/AAUvwnjPuFWs42Vx2yIhK7z1w4L-e1GIpHn_5R1uknbS=s800-c-k-c0x00ffffff-no-rj',
    groups: ['3rd Generation'], twitter: 'houshoumarine',
  ...
  },
  {
    ...
    picture: 'https://yt3.ggpht.com/ytc/AAUvwng8eQJdCX3r4RgCmRGwigXkDp9a2JJSPq-dZcMF=s800-c-k-c0x00ffffff-no-rj',
    groups: ['5th Generation'], twitter: 'yukihanalamy',
    aliases: ['lamy', 'らみ', 'ラミィ']
  },
  {
    name: 'Hololive VTuber Group', ytId: 'UCJFZiqLMntJufDCHc6bQixg',
    chName: "hololive ホロライブ - VTuber Group",
    picture: 'https://yt3.ggpht.com/ytc/AAUvwngST9tdspZgipxxe6KUzq_t-CkbVhCjkmnWxb1uZw=s800-c-k-c0x00ffffff-no-rj',
    groups: ['Group channel'], twitter: 'hololivetv',
    aliases: []
  },
  {
    name: 'Hololive Indonesia', ytId: 'UCfrWoRGlawPQDQxxeIDRP0Q',
    chName: "hololive Indonesia",
    picture: 'https://yt3.ggpht.com/ytc/AAUvwnh523hdzQe8vPD2Du77mqxianT1HHR1McSLHXK4=s800-c-k-c0x00ffffff-no-rj',
    groups: ['Group channel'], twitter: 'hololive_id',
    aliases: []
  },
  {
  ...
  },
  {
    ...
    picture: 'https://yt3.ggpht.com/ytc/AAUvwnjXvzYgBg5mJv8RZLZhgn0-Zb_4zzE1zhCHrJ2w=s800-c-k-c0x00ffffff-no-rj',
    groups: ['Indonesia 2nd Gen'], twitter: 'pavoliareine',
    aliases: ['reine', 'レイネ']
  },
  {
  ...
  },
  {
    ...
    picture: 'https://yt3.ggpht.com/ytc/AAUvwnieM4gqtwmRtapt0va5VTi7BiKHhsYMxOu9qYRR=s800-c-k-c0x00ffffff-no-rj',
    groups: ['Group channel'], twitter: 'hololive_En',
    aliases: []
  },
  {
    name: 'Ayunda Risu', ytId: 'UCOyYb1c43VlX9rc_lT6NKQw',
    chName: "Ayunda Risu Ch. hololive-ID",
    picture: 'https://yt3.ggpht.com/ytc/AAUvwniS_ftaXhqYt1SQPjyuFx5MD_-v0fIUkbCTq5Q_gg=s800-c-k-c0x00ffffff-no-rj',
    groups: ['Indonesia 1st Gen'], twitter: 'ayunda_risu',
    aliases: ['risu', 'ayunda', 'アユンダ', 'リス']
  },
  {
    name: 'Moona Hoshinova', ytId: 'UCP0BspO_AMEe3aQqqpo89Dg',
    chName: "Moona Hoshinova hololive-ID",
    picture: 'https://yt3.ggpht.com/ytc/AAUvwnj-XzL4TRZCzwo-7FCmdsTikQo9wMZwz9RGNoT0XA=s800-c-k-c0x00ffffff-no-rj',
    groups: ['Indonesia 1st Gen'], twitter: 'moonahoshinova',
    aliases: ['moona', 'ムーナ']
  },
  {
  ...
  },
  {
    ...
    chName: "Coco Ch. 桐生ココ",
    picture: 'https://yt3.ggpht.com/ytc/AAUvwniAjGmotDDxZK7psIMoRbqhY7Ici621OQrO7fB9Wg=s800-c-k-c0x00ffffff-no-rj',
    groups: ['4th Generation'], twitter: 'kiryucoco',
  ...
  },
  {
    ...
    picture: 'https://yt3.ggpht.com/ytc/AAUvwniCgko15I_x5bYWm0G2vnf5hZqD5hLOtLEDw0Na=s800-c-k-c0x00ffffff-no-rj',
    groups: ['2nd Generation'], twitter: 'oozorasubaru',
  ...
  },
  {
    ...
    picture: 'https://yt3.ggpht.com/ytc/AAUvwnjIfGLTIQT83r0fKch6BBpK0Vuhgwb5_yfCP7Q=s800-c-k-c0x00ffffff-no-rj',
    groups: ['Indonesia 2nd Gen'], twitter: 'kureijiollie',
    aliases: []
  },
  {
  ...
  },
  {
    ...
    picture: 'https://yt3.ggpht.com/UwxlX1PuB_RwJyEUW_ofbBR6saY8n5_p8A9_1bY65zygFrfqIb1GM8dIK33EJboDDnRVyw=s88-c-k-c0x00ffffff-no-rj',
    groups: ['English'], twitter: 'irys_en',
    aliases: ['irys']
  },
  {
    name: 'Hakos Baelz', ytId: 'UCgmPnx-EEeOrZSg5Tiw7ZRQ',
    chName: "Hakos Baelz Ch. hololive-EN",
    picture: 'https://yt3.ggpht.com/GWIwRbtVQ2TAlvH8Mf37FMpemTrwmUSbTSazp9Aul6KwdKQmvx7IbLZepDk0sp8ReW3qBhsU=s88-c-k-c0x00ffffff-no-rj',
    groups: ['English 2nd Gen'], twitter: 'hakosbaelz',
    aliases: ['baelz', 'hakos']
  },
  {
    name: 'Tsukumo Sana', ytId: 'UCsUj0dszADCGbF3gNrQEuSQ',
    chName: "Tsukumo Sana Ch. hololive-EN",
    picture: 'https://yt3.ggpht.com/d7xnzbFVWHHMrxORQ6w5U6hwtg_NWB2rT6CMZWsQvILip_IH8ukeNkqj9FNmvYm7XfcdyZcLgxA=s88-c-k-c0x00ffffff-no-rj',
    groups: ['English 2nd Gen'], twitter: 'tsukumosana',
    aliases: ['sana']
  },
  {
    name: 'Nanashi Mumei', ytId: 'UC3n5uGu18FoCy23ggWWp8tA',
    chName: "Nanashi Mumei Ch. hololive-EN",
    picture: 'https://yt3.ggpht.com/MI8E8Wfmc_ngNZXUwu8ad0D-OtqDhmqGVULEu25z-ccscwzJpAw-7ewFXzZYLK2jHB9d5OgQDq4=s88-c-k-c0x00ffffff-no-rj',
    groups: ['English 2nd Gen'], twitter: 'nanashimumei_en',
    aliases: ['nanashi', 'mumei']
  },
  {
    name: 'Ouro Kronii', ytId: 'UCmbs8T6MWqUHP1tIQvSgKrg',
    chName: "Ouro Kronii Ch. hololive-EN",
    picture: 'https://yt3.ggpht.com/6670YE31bbAtAi7m_UL-KWZBdL5wvmfHlLtcS4HxsBZBQNqmAk7Y-iiIOjawO_0HYXpS4HfC=s88-c-k-c0x00ffffff-no-rj',
    groups: ['English 2nd Gen'], twitter: 'ourokronii',
    aliases: ['kronii']
  },
  {
    name: 'Ceres Fauna', ytId: 'UCO_aKKYxn4tvrqPjcTzZ6EQ',
    chName: "Ceres Fauna Ch. hololive-EN",
    picture: 'https://yt3.ggpht.com/0lkccaVapSr1Z3uuXWbnaQxeqRWr9Tcs4R9rLBRSrAsN9gLacpiT2OFWfFKr4NhF97_hqK3eTg=s88-c-k-c0x00ffffff-no-rj',
